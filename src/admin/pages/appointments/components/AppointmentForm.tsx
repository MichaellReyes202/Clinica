...
export const AppointmentForm = ({ mode = "create", initialStart = "", initialEvent, onClose, setIsPosting, doctorBySpecialty, onEventSaved, }: AppointmentFormProps) => {
   ...
   const { handleSubmit, register, setValue, watch, clearErrors, reset, formState: { errors }, setError } = useForm<AppointmentFormValues>({
   ...
   return (
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
         ...
         {isNonEditable && (
            <Alert className="border-yellow-600 bg-yellow-50 dark:bg-yellow-950 dark:border-yellow-800">
