...
export const PatientHistoryContent = ({ patientId }: PatientHistoryContentProps) => {
    ...
    // Hooks for data
    const { patient, isLoading: isLoadingPatient } = usePatientDetail(patientId.toString());
    ...
    if (isLoading) return <div className="py-10"><CustomFullScreenLoading /></div>;
